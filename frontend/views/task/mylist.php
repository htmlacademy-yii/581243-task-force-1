    ...
    <div class="main-container page-container">
        <section class="menu-toggle">
            <ul class="menu-toggle__list">
                <li class="menu-toggle__item <?= (int)$status !== Status::STATUS_DONE ?: 'menu_toggle__item--current'; ?> menu-toggle__item--completed">
                    ...
                    <a href="<?= Url::to(['task/mylist/' . Status::STATUS_DONE]); ?>">
                        Завершённые
                    </a>
                </li>
                <li class="menu-toggle__item <?= (int)$status !== Status::STATUS_NEW ?: 'menu_toggle__item--current'; ?> menu-toggle__item--new">
                    <div class="menu-toggle__svg-wrapper">
                    ...
                    <a href="<?= Url::to(['task/mylist/' . Status::STATUS_NEW]); ?>">
                        Новые
                    </a>
                </li>
                <li class="menu-toggle__item <?= (int)$status !== Status::STATUS_IN_WORK ?: 'menu_toggle__item--current'; ?> menu-toggle__item--active">
                    <div class="menu-toggle__svg-wrapper">
                    ...
                    <a href="<?= Url::to(['task/mylist/' . Status::STATUS_IN_WORK]); ?>">
                        Активные
                    </a>
                </li>
                <li class="menu-toggle__item <?= (int)$status !== Status::STATUS_CANCEL ?: 'menu_toggle__item--current'; ?> menu-toggle__item--canceled">
                    <div class="menu-toggle__svg-wrapper">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="<?= Url::to(['task/mylist/' . Status::STATUS_CANCEL]); ?>">
                        Отменённые
                    </a>
                </li>
                <li class="menu-toggle__item <?= (int)$status !== Status::STATUS_EXPIRED ?: 'menu_toggle__item--current'; ?> menu-toggle__item--hidden">
                    <div class="menu-toggle__svg-wrapper">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="<?= Url::to(['task/mylist/' . Status::STATUS_EXPIRED]); ?>">
                        Просроченные
                    </a>
                </li>
            </ul>
        ...
        <section class="my-list">
            <div class="my-list__wrapper">
                ...
                <div class="new-task__card">
                    ...
                    <?php if ($task->task_status_id === Status::STATUS_NEW): ?>
                        <div class="task-status new-status">Новый</div>
                    <?php elseif ($task->task_status_id === Status::STATUS_DONE): ?>
                        <div class="task-status done-status">Завершено</div>
                    <?php endif; ?>
                    <p class="new-task_description">
                        <?= StringHelper::truncate($task->description, 150, '...'); ?>
                    </p>
                    ...
                    <div class="feedback-card__top ">
                        ...
                        <div class="feedback-card__top--name my-list__bottom">
                            <p class="link-name"><a href="<?=Url::to(['/users/view/' . $task->executor->id]); ?>" class="link-regular"><?= $task->executor->name; ?></a></p>
